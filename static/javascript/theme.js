...
(function($) {
        ...
        function HideLoad() {
            ...
            if ($(".ph-image").length) {
                if ($("#page-header").hasClass("ph-bg-image")) {
                    tl_transitOut.from(".ph-image img, .ph-video", {
                        duration: 1.5,
                        y: 80,
                        autoAlpha: 0,
                        stagger: 0.3,
            ...
            if ($("#page-header .project-info-list").length) {
                if ($("#page-header").hasClass("ph-inline")) {
                    tl_transitOut.from("#page-header .project-info-list > ul > li", {
                        duration: 1.5,
                        y: 80,
                        autoAlpha: 0,
                        stagger: 0.15,
                    ...
                    tl_transitOut.from("#page-header .project-info-list > ul", {
                        duration: 1.5,
                        y: 80,
                        autoAlpha: 0,
                        ease: Expo.easeOut,
            ...
            if ($(".tt-psc-elem").length) {
                ...
                tl_transitOut.from(".tt-ps-appear", {
                    duration: 1.5,
                    y: 80,
                    autoAlpha: 0,
                    stagger: 0.3,
            ...
            if ($(".tt-pci-title").length) {
                tl_transitOut.from(".tt-pci-title", {
                    duration: 1.5,
                    x: 80,
                    autoAlpha: 0,
                    skewX: "-10deg",
            ...
            if ($(".tt-pci-category").length) {
                tl_transitOut.from(".tt-pci-category", {
                    duration: 1.5,
                    x: 80,
                    autoAlpha: 0,
                    ease: Expo.easeOut,
            ...
            if ($portfolioHoverCarousel.length) {
                if ($portfolioHoverCarouselItem.length) {
                    tl_transitOut.from($portfolioHoverCarouselItem, {
                        duration: 2,
                        autoAlpha: 0,
                        y: 80,
                        stagger: 0.2,
                ...
                if ($portfolioHoverCarouselCounter.length) {
                    tl_transitOut.from($portfolioHoverCarouselCounter, {
                        duration: 2,
                        y: 20,
                        autoAlpha: 0,
                        ease: Expo.easeInOut,
            ...
            tl_transitOut.from("#page-content", {
                duration: 1.5,
                autoAlpha: 0,
                y: 80,
                ease: Expo.easeOut,
    ...
    if ($(".tt-search").length) {
        ...
        $(".tt-search-trigger").on("click", function() {
            ...
            tl_ttSearchIn.from(".tt-search-appear", {
                duration: 0.5,
                y: 80,
                autoAlpha: 0,
                stagger: 0.1,
            ...
            var $ttPortfolioSliderSwiper = new Swiper($ttPortfolioSlider.find(".swiper")[0], {
                ...
                on: {
                    ...
                    transitionStart: function() {
                        ...
                        gsap.fromTo($ttPortfolioSlider.find(".tt-psc-elem"), {
                            autoAlpha: 1,
                            y: 0
                        }, {
                            duration: 0.25,
    ...
    if ($(".ph-share").length) {
        ...
        $(".ph-share-icon").on("click", function() {
            ...
            tl_prshIn.from(".ph-share-appear", {
                duration: 0.5,
                y: 80,
                autoAlpha: 0,
                stagger: 0.1,
        ...
        $(".ph-share-close, .ph-share-close-btn").on("click", function() {
            ...
            tl_prshOut.to(".ph-share-content", {
                duration: 0.4,
                autoAlpha: 0,
                clearProps: "all"
            }, "+=0.2");
    ...
    if ($("#page-header").hasClass("ph-content-parallax")) {
        ...
        if ($(".ph-image").length) {
            if ($("#page-header").hasClass("ph-bg-image")) {
                tlPhParallax.to(".ph-image-inner", {
                    yPercent: 30,
                    scale: 1.05
                }, 0);
            } else {
    ...
    function ttCatNavClose() {
        $(".ttgr-cat-nav").on("click", function() {
            ...
            tl_ttgrClose.to(".ttgr-cat-nav", {
                duration: 0.3,
                autoAlpha: 0,
                clearProps: "all"
            }, "+=0.2");
            tl_ttgrClose.to(".portfolio-grid-item", {
                duration: 0.3,
                scale: 1,
                clearProps: "all"
            }, "-=0.4");
            tl_ttgrClose.to(".pgi-caption, #page-header, .ttgr-cat-trigger", {
                duration: 0.3,
                autoAlpha: 1,
                clearProps: "all"
            }, "-=0.4");
